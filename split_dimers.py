...
# Base directories
xyz_dir = os.path.join(r"C:\Users\Alex Isaev\Documents\Physics Thesis Automated Multi-Fidelity SAPT(DFT) Workflows\Code\data\s22_xyz")
output_dir = os.path.join(r"C:\Users\Alex Isaev\Documents\Physics Thesis Automated Multi-Fidelity SAPT(DFT) Workflows\Code\data\s22_split")
