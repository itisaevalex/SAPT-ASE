...
def test_deduplicate_actual_basis_considered(tmp_path: Path):
    ...
    SaptTask(
        id="task1_orig_null_actual", monomer_a=MOL_A, monomer_b=MOL_B_1, basis_set="sto-3g", method="sapt0"
    )
    result1 = SaptResult(
        task_id="task1_orig_null_actual", success=True, energies={"total": -1.0},
        basis_set="sto-3g", actual_basis_set=None, method="sapt0",
        monomer_a_xyz=MOL_A_XYZ, monomer_b_xyz=MOL_B_XYZ_1,
        timestamp_utc="2023-01-01T00:00:00Z", attempt_number=1, elapsed_time=0.1
    )
    ...
    SaptTask(
        id="task2_dup_actual_matches_orig", monomer_a=MOL_A, monomer_b=MOL_B_1, basis_set="6-31g", method="sapt0"
    )
    result2 = SaptResult(
        task_id="task2_dup_actual_matches_orig", success=True, energies={"total": -1.1},
        basis_set="6-31g", actual_basis_set="sto-3g", method="sapt0",
        monomer_a_xyz=MOL_A_XYZ, monomer_b_xyz=MOL_B_XYZ_1,
        timestamp_utc="2023-01-01T01:00:00Z", attempt_number=1, elapsed_time=0.1
    )
    db.log_task_attempt(run_id="run1", result=result2) # log_id 2

    # Task 3: Unique because actual_basis_set is different ('6-31g')
    SaptTask(
        id="task3_unique_actual_differs", monomer_a=MOL_A, monomer_b=MOL_B_1, basis_set="sto-3g", method="sapt0"
    )
    result3 = SaptResult(
        task_id="task3_unique_actual_differs", success=True, energies={"total": -1.2},
        basis_set="sto-3g", actual_basis_set="6-31g", method="sapt0", # Effective basis is '6-31g'
        monomer_a_xyz=MOL_A_XYZ, monomer_b_xyz=MOL_B_XYZ_1,
        timestamp_utc="2023-01-01T02:00:00Z", attempt_number=1, elapsed_time=0.1
    )
    ...
    SaptTask(
        id="task4_dup_actual_is_orig", monomer_a=MOL_A, monomer_b=MOL_B_1, basis_set="sto-3g", method="sapt0"
    )
    result4 = SaptResult(
        task_id="task4_dup_actual_is_orig", success=True, energies={"total": -1.3},
        basis_set="sto-3g", actual_basis_set="sto-3g", method="sapt0", # Effective basis is 'sto-3g'
        monomer_a_xyz=MOL_A_XYZ, monomer_b_xyz=MOL_B_XYZ_1,
        timestamp_utc="2023-01-01T03:00:00Z", attempt_number=1, elapsed_time=0.1
    )
